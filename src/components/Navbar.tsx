      ...
      <div className="hidden md:block">
        <div className="btn-glow-border group shadow-lg shadow-blue-500/10">
          <a
            ...
            className="relative z-10 inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-[5px] transition-all font-medium text-sm active:scale-95"
          >
